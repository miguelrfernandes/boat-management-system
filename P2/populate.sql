...
-- boat
INSERT INTO boat(country_name, cin, boat_name, length, class_name, year)
...
-- sailor
INSERT INTO sailor(email, first_name, surname)
...
-- sailing_certificate
INSERT INTO sailing_certificate(sailor_email, issue_date, expiry_date, for_class_name)
...
-- valid_for
INSERT INTO valid_for(sailor_email, issue_date, country_name)
...
-- reservation
INSERT INTO reservation(boat_country_name, boat_cin, start_date, end_date, responsible_sailor_email)
VALUES ('Spain', 'CNBZA653A212', TO_DATE('2001-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD'), 'columbus@email.com'),
    ('England', 'CNBZA653B168', TO_DATE('2002-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD'), 'popeye@email.com'),
    ('France', 'CNBZA653A191', TO_DATE('2004-03-24', 'YYYY-MM-DD'), TO_DATE('2005-07-26', 'YYYY-MM-DD'), 'harry@hogwarts.com'),
    ('Portugal', 'CNBZA653A219', TO_DATE('2006-03-24', 'YYYY-MM-DD'), TO_DATE('2006-07-26', 'YYYY-MM-DD'), 'joaosantos@email.com'),
    ('Portugal', 'CNBZA653A219', TO_DATE('2007-03-24', 'YYYY-MM-DD'), TO_DATE('2007-07-26', 'YYYY-MM-DD'), 'popeye@email.com'),
    ('Portugal', 'CNBZA653A218', TO_DATE('2008-03-24', 'YYYY-MM-DD'), TO_DATE('2008-07-26', 'YYYY-MM-DD'), 'popeye@email.com');

-- trip
INSERT INTO trip(boat_country_name, boat_cin, start_date, end_date, take_off, arrival, insurance, from_location_latitude, from_location_longitude, to_location_latitude, to_location_longitude, skipper_email)
VALUES ('Spain', 'CNBZA653A212', TO_DATE('2001-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD'), TO_DATE('2001-03-27', 'YYYY-MM-DD'), TO_DATE('2001-07-23', 'YYYY-MM-DD'), 'IN-123456789', 38.736946, -9.142685, 37.019356, -7.930440, 'columbus@email.com'),
    ('Spain', 'CNBZA653A212', TO_DATE('2001-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD'), TO_DATE('2002-03-27', 'YYYY-MM-DD'), TO_DATE('2002-07-23', 'YYYY-MM-DD'), 'IN-123456789', 41.385064, 2.173403, 39.469907, -0.377398, 'popeye@email.com'),
    ('England', 'CNBZA653B168', TO_DATE('2002-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD'), TO_DATE('2002-03-27', 'YYYY-MM-DD'), TO_DATE('2002-07-23', 'YYYY-MM-DD'), 'IN-123456789', 51.507351, -0.127758, 53.480759, -2.242631, 'dumbledore@hogwarts.com'),
    ('France', 'CNBZA653A191', TO_DATE('2004-03-24', 'YYYY-MM-DD'), TO_DATE('2005-07-26', 'YYYY-MM-DD'), TO_DATE('2004-03-27', 'YYYY-MM-DD'), TO_DATE('2004-07-23', 'YYYY-MM-DD'), 'IN-123456789', 51.926517, 4.462456, 52.377956, 4.897070, 'ron@hogwarts.com'),
    ('France', 'CNBZA653A191', TO_DATE('2004-03-24', 'YYYY-MM-DD'), TO_DATE('2005-07-26', 'YYYY-MM-DD'), TO_DATE('2005-03-27', 'YYYY-MM-DD'), TO_DATE('2005-07-23', 'YYYY-MM-DD'), 'IN-123456789', 38.736946, -9.142685, 41.385064, 2.173403, 'hermione@hogwarts.com');

-- authorised
INSERT INTO authorised(sailor_email, boat_country_name, boat_cin, start_date, end_date)
VALUES ('columbus@email.com', 'Spain', 'CNBZA653A212', TO_DATE('2001-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD')),
    ('jacksparrow@email.com', 'Spain', 'CNBZA653A212', TO_DATE('2001-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD')),
    ('popeye@email.com', 'Spain', 'CNBZA653A212', TO_DATE('2001-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD')),
    ('popeye@email.com','England', 'CNBZA653B168', TO_DATE('2002-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD')),
    ('dumbledore@hogwarts.com','England', 'CNBZA653B168', TO_DATE('2002-03-24', 'YYYY-MM-DD'), TO_DATE('2002-07-26', 'YYYY-MM-DD')),
    ('hermione@hogwarts.com','France', 'CNBZA653A191', TO_DATE('2004-03-24', 'YYYY-MM-DD'), TO_DATE('2005-07-26', 'YYYY-MM-DD')),
    ('harry@hogwarts.com','France', 'CNBZA653A191', TO_DATE('2004-03-24', 'YYYY-MM-DD'), TO_DATE('2005-07-26', 'YYYY-MM-DD')),
    ('ron@hogwarts.com','France', 'CNBZA653A191', TO_DATE('2004-03-24', 'YYYY-MM-DD'), TO_DATE('2005-07-26', 'YYYY-MM-DD')),
    ('joaosantos@email.com','Portugal', 'CNBZA653A219', TO_DATE('2006-03-24', 'YYYY-MM-DD'), TO_DATE('2006-07-26', 'YYYY-MM-DD')),
    ('harry@hogwarts.com','Portugal', 'CNBZA653A219', TO_DATE('2006-03-24', 'YYYY-MM-DD'), TO_DATE('2006-07-26', 'YYYY-MM-DD')),
    ('popeye@email.com', 'Portugal', 'CNBZA653A219', TO_DATE('2007-03-24', 'YYYY-MM-DD'), TO_DATE('2007-07-26', 'YYYY-MM-DD'));